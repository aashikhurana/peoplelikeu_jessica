...
$includeTreeViewVariables: $includeTreeViewClasses !default;

@if $includeTreeViewVariables != false {
...
@if $includeTreeViewVariables != false {
  @include module-include-once("alta.web.variables.treeview") {
...
:root {
  ...
  --oj-tree-view-item-bg-color-selected:          var(--oj-brand-color-light-4);
