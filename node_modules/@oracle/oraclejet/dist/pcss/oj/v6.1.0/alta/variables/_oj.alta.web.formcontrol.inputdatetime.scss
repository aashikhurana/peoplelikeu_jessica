...
@import "oj.alta.web.formcontrol.listbox";
@import "oj.alta.web.messages";


@if $includeInputDateTimeVariables != false {
  @include module-include-once("alta.web.variables.inputdatetime") {
...
:root {
  ...
  --oj-date-time-picker-switcher-padding:       5px 15px;
  --oj-date-time-picker-switcher-bg-color:      var(--oj-neutral-color-5);
  ...
  --oj-datepicker-bg-color-selected:            var(--oj-brand-color);
