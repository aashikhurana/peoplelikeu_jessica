...
$includeTimelineVariables: $includeTimelineClasses !default;

@if $includeTimelineVariables != false {
  $includeDvtBaseVariables: true !global;
}

// import dependencies
@import "oj.alta.web.dvt";

@if $includeTimelineVariables != false {
  @include module-include-once("alta.web.variables.timeline") {
...
:root {
    ...
    --oj-timeline-tooltip-label-color:                   var(--oj-text-color-5);
    ...
    --oj-timeline-major-axis-separator-color:            var(--oj-neutral-color-10);  
