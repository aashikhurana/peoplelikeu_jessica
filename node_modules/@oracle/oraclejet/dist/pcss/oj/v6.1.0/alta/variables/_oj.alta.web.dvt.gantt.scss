...
$includeGanttVariables: $includeGanttClasses !default;

@if $includeGanttVariables != false {
...
@if $includeGanttVariables != false {
  @include module-include-once("alta.web.variables.gantt") {
...
:root {
    ...
    --oj-gantt-tooltip-label-color:                      var(--oj-text-color-5);
}
