...
$includeDvtBaseVariables: $includeDvtBaseClasses !default;

@if $includeDvtBaseVariables != false {
  @include module-include-once("alta.web.variables.dvtbase") {
:root {
    ...
    --oj-dvt-tooltip-bg-color:                 var(--oj-neutral-color-2);
    ...
    --oj-dvt-icon-bg-color-active:             var(--oj-dvt-icon-bg-color);
    --oj-dvt-icon-border-color-active:         var(--oj-dvt-icon-border-color);
}
