...
$includeTreemapVariables: $includeTreemapClasses !default;

@if $includeTreemapVariables != false {
...
@if $includeTreemapVariables != false {
  @include module-include-once("alta.web.variables.treemap") {
:root {
  // treemap
  // ----------------------------                        
  ...
  --oj-treemap-legend-label-color:                     var(--oj-text-color-5);
