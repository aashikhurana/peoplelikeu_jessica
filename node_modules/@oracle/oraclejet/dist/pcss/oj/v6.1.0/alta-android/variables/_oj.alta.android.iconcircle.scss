...
$includeIconCircleVariables: $includeIconCircleClasses !default;

@if $includeIconCircleVariables != false {
  @include module-include-once("alta.android.variables.iconcircle") {

:root {
  // icon circle
  // ----------------------------
  --oj-icon-circle-inner-bg-color:            var(--oj-neutral-color-13);
