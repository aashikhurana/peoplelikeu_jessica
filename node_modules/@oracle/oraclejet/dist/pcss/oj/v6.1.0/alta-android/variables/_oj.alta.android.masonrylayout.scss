...
$includeMasonryLayoutVariables: $includeMasonryLayoutClasses !default;

@if $includeMasonryLayoutVariables != false {
  @include module-include-once("alta.android.variables.masonrylayout") {
