...
@if $includeLabelVariables != false {
  @include module-include-once("alta.android.variables.label") {
...
:root {
    ...
    --oj-form-control-label-font-size:     var(--oj-font-size-xs);
    ...
    --oj-form-control-label-required-icon-background-color: var(--oj-brand-color-dark-1);
    ...
    --oj-form-control-inline-gutter:       1rem;
