...
@if $includeMessagesVariables != false {
  @include module-include-once("alta.android.variables.messages") {
    ...
    :root {
      ...
      --oj-messages-general-overlay-max-width:         1536px;
      ...
      --oj-messages-notification-overlay-max-width:      768px;
