...
@if $includeCollectionVariables != false {
  @include module-include-once("alta.android.variables.collection") {
...
:root {
  ...
  // in old syntax would be the max of var(--oj-form-control-input-height) and this value but not allowed to max in new syntax
  // if modifying for control height to be greater than this var must also be updated.
  --oj-collection-column-width:                            4.25rem;
  --oj-collection-row-height:                              2.9375rem;

  // header
  --oj-collection-header-font-size:                        var(--oj-font-size-xs);
  --oj-collection-header-font-weight:                      var(--oj-header-font-weight);
  ...
  --oj-collection-header-height:                           3.4375rem;
  ...
  // header selected
  --oj-collection-header-bg-color-selected:                var(--oj-neutral-color-9);

  // header selected inactive (selected but focus outside the component)
// todo: I thought now the selected and selected inactive colors were supposed to match?
  ...
  --oj-collection-header-drag-image-border-color:          var(--oj-neutral-color-10);
  ...
  --oj-collection-cell-font-size:                          0.8125rem;
  ...
  --oj-collection-cell-padding:                            0.5rem;
