...
$switchTrackBgColorSelected: red; //settings: ignore
$switchTrackBorderColorSelected: red; //settings: ignore
$switchThumbBorderColorHover: red; //settings: ignore
$switchThumbBorderColorSelectedHover: red; //settings: ignore
$switchThumbBorderWidthHover: 2px; //settings: ignore
...
$popupTailBorderColor:      unquote('hsl(203, 2%, 78%)') !default; //settings: ignore
