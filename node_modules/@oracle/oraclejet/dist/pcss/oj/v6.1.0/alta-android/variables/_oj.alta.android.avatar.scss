...
$includeAvatarVariables: $includeAvatarClasses !default;

@if $includeAvatarVariables != false {
  @include module-include-once("alta.android.variables.avatar") {
...
:root {
  ...
  // avatar
  // ----------------------------
  --oj-avatar-inner-bg-color:                 var(--oj-neutral-color-13);
