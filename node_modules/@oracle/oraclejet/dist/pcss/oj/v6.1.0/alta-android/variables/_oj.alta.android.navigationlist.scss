...
// import dependencies
@import "oj.alta.android.tabbar";
@import "oj.alta.android.toolbar";
@import "oj.alta.android.treeview";
@import "oj.alta.android.menu";
@import "oj.alta.android.panel";

@if $includeNavigationListVariables != false {
  @include module-include-once("alta.android.variables.navigationlist") {

:root {
  // nav list
  // ----------------------------
  --oj-navigation-list-category-divider-color:             var(--oj-neutral-color-8);
  --oj-navigation-list-icon-only-icon-start-end-padding:   16px;
  --oj-navigation-list-horizontal-font-size:               0.75rem;
  --oj-navigation-list-horizontal-icon-margin:             4px;
  ...
  --oj-navigation-list-horizontal-item-min-height:         3.5rem;
  --oj-navigation-list-horizontal-item-stacked-min-height: 3.5rem;
  ...
  --oj-navigation-list-horizontal-item-padding:            2px 0.625rem 6px;
  --oj-navigation-list-horizontal-item-stacked-padding:    1px 0.625rem 0;
  ...
  // contrast default
  --oj-navigation-list-item-contrast-label-color-default:      var(--oj-neutral-color-10);
