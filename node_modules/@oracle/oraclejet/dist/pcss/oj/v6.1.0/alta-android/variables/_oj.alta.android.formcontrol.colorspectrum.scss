...
$includeColorSpectrumVariables: $includeColorSpectrumClasses !default;

@if $includeColorSpectrumVariables != false {
...
@if $includeColorSpectrumVariables != false {
  @include module-include-once("alta.android.variables.colorspectrum") {
