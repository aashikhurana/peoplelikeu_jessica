...
$includeThematicMapVariables: $includeThematicMapClasses !default;

@if $includeThematicMapVariables != false {
...
@if $includeThematicMapVariables != false {
  @include module-include-once("alta.android.variables.ThematicMap") {
