...
$includeColorPaletteVariables: $includeColorPaletteClasses !default;

@if $includeColorPaletteVariables != false {
...
@if $includeColorPaletteVariables != false {
  @include module-include-once("alta.windows.variables.colorpalette") {
