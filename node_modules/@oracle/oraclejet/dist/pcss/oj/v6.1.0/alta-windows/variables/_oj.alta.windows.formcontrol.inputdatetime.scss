...
$includeInputDateTimeVariables: $includeInputDateTimeClasses !default;

@if $includeInputDateTimeVariables != false {
  $includeListboxVariables: true !global;
...
@if $includeInputDateTimeVariables != false {
  @include module-include-once("alta.windows.variables.inputdatetime") {
...
:root {
  ...
  --oj-date-time-picker-switcher-bg-color:      var(--oj-neutral-color-6);
  ...
  --oj-datepicker-button-text-color-active:     var(--oj-datepicker-button-text-color);
  ...
  --oj-datepicker-bg-color-selected:            var(--oj-brand-color-dark-2);
  ...
  --oj-datepicker-inline-bg-color:              var(--oj-neutral-color-1); //settings: ignore
  --oj-datepicker-inline-border-color:          var(--oj-neutral-color-8); //settings: ignore
