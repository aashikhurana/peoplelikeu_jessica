...
$includeSwipeActionsVariables: $includeSwipeActionsClasses !default;

@if $includeSwipeActionsVariables != false {
...
@if $includeSwipeActionsVariables != false {
  @include module-include-once("alta.windows.variables.swipeactions") {
