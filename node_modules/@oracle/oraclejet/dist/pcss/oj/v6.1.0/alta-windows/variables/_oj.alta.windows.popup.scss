...
@if $includePopupVariables != false {
  @include module-include-once("alta.windows.variables.popup") {
    :root {
      --oj-popup-border-width:             2px;
      --oj-popup-border-color:             var(--oj-neutral-color-10);
      ...
      --oj-popup-tail-border-width:       var(--oj-popup-border-width);
