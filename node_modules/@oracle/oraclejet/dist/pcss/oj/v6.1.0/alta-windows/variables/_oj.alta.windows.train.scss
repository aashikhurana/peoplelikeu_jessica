...
@if $includeTrainVariables != false {
  @include module-include-once("alta.windows.variables.train") {

    :root {
      // train
      --oj-train-step-width:                       105px;
    ...
    // todo: comment says  "message icon diameter", is this only for messaging? If so rename?
      ...
      //oj-train-connector-has-fill is 0 for individual and 1 for continuous
      ...
      --oj-train-connector-bg-color:               var(--oj-neutral-color-9);
      ...
      // active
      --oj-train-bg-color-active:                  var(--oj-neutral-color-7);
