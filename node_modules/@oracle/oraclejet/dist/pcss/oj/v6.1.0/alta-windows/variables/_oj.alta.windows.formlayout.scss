...
@if $includeFormLayoutVariables != false {
  @include module-include-once("alta.windows.variables.formlayout") {
...
:root {
  ...
  // to maintain label's height, and we need a different top margin for this case.
    --oj-form-layout-label-inline-margin-top: 0.2em;
  ...
  --oj-form-layout-label-inline-gutter-padding: 1.33333rem;
  ...
  //   }
  --oj-form-layout-label-inline-radio-checkbox-margin-top: 0.58rem;
}
