...
// import dependencies
@import "oj.alta.windows.tabbar";
@import "oj.alta.windows.toolbar";
@import "oj.alta.windows.treeview";
@import "oj.alta.windows.menu";
@import "oj.alta.windows.panel";

@if $includeNavigationListVariables != false {
  @include module-include-once("alta.windows.variables.navigationlist") {
...
:root {
  ...
  --oj-navigation-list-horizontal-font-size:               0.8rem;
  ...
  --oj-navigation-list-horizontal-item-min-height:         3.2rem;  
  --oj-navigation-list-horizontal-item-stacked-min-height: 4rem;  
  ...
  --oj-navigation-list-horizontal-item-padding:            4px 0.625rem 2px;
  --oj-navigation-list-horizontal-item-stacked-padding:    3px 0.625rem 2px;
