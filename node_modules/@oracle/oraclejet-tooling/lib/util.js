...
/**
 * Used to copy component spec to the application's destination directory.
 * @private
 * @param {String} path to component
 */
util.copyScriptsToDest = function (componentPath) {
  const destPath = this.getComponentDest(componentPath);
